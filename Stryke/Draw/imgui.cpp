...
void ImGui::RenderArrow(ImDrawList* draw_list, ImVec2 pos, ImU32 col, ImGuiDir dir, float scale)
{
    ...
    ImVec2 a, b, c, d; //d is an extra addition
    switch (dir)
    {
    case ImGuiDir_Up:
    case ImGuiDir_Down:
        ...
        //default ImGui Code Above - Replaced
        a = ImVec2(-0.750f, +0.1f) * r;
        b = ImVec2(+0.750f, -0.1f) * r;
        draw_list->AddRectFilled(center + a, center + b, ImU32(IM_COL32(clg.GetCSS().GetTextActive().x * 255.f, clg.GetCSS().GetTextActive().y * 255.f, clg.GetCSS().GetTextActive().z * 255.f, clg.GetCSS().GetTextActive().w * 255.f)));
        //forms a 'minus' around the center
        break;
    case ImGuiDir_Left:
    case ImGuiDir_Right:
        ...
        b = ImVec2(+0.750f, -0.1f) * r;
        draw_list->AddRectFilled(center + a, center + b, ImU32(IM_COL32(clg.GetCSS().GetTextActive().x * 255.f, clg.GetCSS().GetTextActive().y * 255.f, clg.GetCSS().GetTextActive().z * 255.f, clg.GetCSS().GetTextActive().w * 255.f)));
        c = ImVec2(-0.1f, +0.750f) * r;
        d = ImVec2(+0.1f, -0.750f) * r;
        draw_list->AddRectFilled(center + c, center + d, ImU32(IM_COL32(clg.GetCSS().GetTextActive().x * 255.f, clg.GetCSS().GetTextActive().y * 255.f, clg.GetCSS().GetTextActive().z * 255.f, clg.GetCSS().GetTextActive().w * 255.f)));
        //default minus formed, in addition to a vertical minus to form a plus.
        break;
    case ImGuiDir_None:
    case ImGuiDir_COUNT:
        IM_ASSERT(0);
